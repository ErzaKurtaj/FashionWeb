document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'BLAZER & SKIRT';
      const price = '65.95 EUR';
      const image = '/assets/images/STREET.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('BLAZER & SKIRT', '65.95 EUR', '/assets/images/STREET.jpg', selectedSize);
  });
