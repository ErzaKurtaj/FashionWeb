document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'MINT DRESS & BLAZER';
      const price = '87.95 EUR';
      const image = '/assets/images/mint.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('MINT DRESS & BLAZER', '27.95 EUR', '/assets/images/mint.jpg', selectedSize);
  });
