document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'NECK SWEATER';
      const price = '27.95 EUR';
      const image = '/assets/images/sweater.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('NECK SWEATER', '27.95 EUR', '/assets/images/sweater.jpg', selectedSize);
  });
