document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'BASIC T-SHIRT';
      const price = '17.95 EUR';
      const image = '/assets/images/tshirt.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('BASIC T-SHIRT', '17.95 EUR', '/assets/images/tshirt.jpg', selectedSize);
  });
