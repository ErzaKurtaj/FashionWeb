document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'WHITE LONG DRESS';
      const price = '45.95 EUR';
      const image = '/assets/images/whitedress.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('WHITE LONG DRESS', '45.95 EUR', '/assets/images/whitedress.jpg', selectedSize);
  });
