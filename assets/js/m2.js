document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'CUTE PINK DRESS';
      const price = '29.95 EUR';
      const image = '/assets/images/cute.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('CUTE PINK DRESS', '29.95 EUR', '/assets/images/cute.jpg', selectedSize);
  });
