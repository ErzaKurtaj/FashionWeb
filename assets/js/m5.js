document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'SATIN BLACK DRESS';
      const price = '35.95 EUR';
      const image = '/assets/images/cutest.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('SATIN BLACK DRESS', '35.95 EUR', '/assets/images/cutest.jpg', selectedSize);
  });
