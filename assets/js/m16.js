document.addEventListener("DOMContentLoaded", function() {
  ...
  addToCartButton.addEventListener('click', function() {
      ...
      const name = 'OVERSIZE JACKET';
      const price = '42.95 EUR';
      const image = '/assets/images/jacket.jpg';
  ...
  document.querySelector('.plus-btn').addEventListener('click', function() {
      ...
      incrementItem();
      addToCart('OVERSIZE JACKET', '42.95 EUR', '/assets/images/jacket.jpg', selectedSize);
  });
